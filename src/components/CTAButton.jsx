...
// CTA em pílula, caixa-alta, azul sólido.
//
  ...
  return (
    <motion.a
      ...
      className={
        ...
        "text-sm md:text-base font-semibold uppercase tracking-[0.12em] text-white " +
        "transition-shadow duration-300 hover:shadow-[0_14px_44px_rgba(45,127,255,0.45)] " +
